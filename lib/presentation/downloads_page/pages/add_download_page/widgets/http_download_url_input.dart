...
class HttpDownloadUrlInput extends StatefulWidget {
  const HttpDownloadUrlInput({super.key});

  @override
  State<HttpDownloadUrlInput> createState() => _HttpDownloadUrlInputState();
}

class _HttpDownloadUrlInputState extends State<HttpDownloadUrlInput> {
          ...
          BlocBuilder<AddDownloadBloc, AddDownloadBlocState>(
            builder: (context, state) {
              if (state is AddDownloadBlocStateLoaded) {
                ...
                return Input(
                  hintText: AppConstant.httpUrlHintText,
